...
namespace AccesPoint.Users
{
    public class UserData : IUserData
    {
        ...
        public Task UpdateMember(User user) => _db.SaveData("EXEC [dbo].[dspUpdateUmbracoUser] @id, @userDisabled, @userName, @userLogin, @userPassword, @kind, @avatarBinary, @lastPasswordChangeDate", user, "DefaultConnection");
    }
}